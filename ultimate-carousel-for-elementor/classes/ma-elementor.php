...
class UCFE_Elementor {
	...
	public function uae_front_enqueue_styles() {
		...
		wp_enqueue_script( 'fancy-elementor-flipbox', plugins_url( '../js/fancy-elementor-flipbox.js', __FILE__ ), [ 'jquery' ], false, true );
		wp_enqueue_style('fancy-elementor-flipbox-css',   plugins_url( '../css/fancy-elementor-flipbox.css', __FILE__ ) );
